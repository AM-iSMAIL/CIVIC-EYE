      ...
      <div className="flex flex-col sm:flex-row gap-3 items-center justify-between">
        <div className="relative w-full sm:w-80">
          ...
          <input
            ...
            className="w-full pl-9 pr-3 py-2 rounded-xl bg-slate-50 border border-slate-200 text-xs text-slate-900 placeholder-slate-400 focus:outline-none focus:border-blue-500 transition-colors"
          />
        </div>

        <div className="flex items-center gap-3 w-full sm:w-auto justify-between sm:justify-end">
          <span className="text-xs text-slate-500 font-mono">
            Showing <span className="font-bold text-slate-900">{totalCount}</span> incidents
          </span>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-2.5 pt-1">
        ...
        <div>
          ...
          <select
            ...
            className="w-full py-2 px-2.5 rounded-xl bg-white border border-slate-200 text-xs text-slate-700 focus:outline-none focus:border-blue-500 cursor-pointer"
          >
        ...
        <div>
          ...
          <button
            ...
            className="w-full py-2 px-2.5 rounded-xl bg-white border border-slate-200 text-xs text-slate-700 hover:text-slate-950 flex items-center justify-between cursor-pointer"
          >
